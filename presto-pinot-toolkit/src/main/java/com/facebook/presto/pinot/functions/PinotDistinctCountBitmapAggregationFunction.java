...
@AggregationFunction("distinctCountBitmap")
public class PinotDistinctCountBitmapAggregationFunction
{
    private PinotDistinctCountBitmapAggregationFunction()
    {
    }
    ...
    {
        throw new IllegalStateException("Expected 'distinctCountBitmap' function to be always pushed down to Pinot.");
    }
